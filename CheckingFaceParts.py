        ...
        with mp_face_mesh.FaceMesh(
          ...
          #for idx, file in enumerate(IMAGE_FILES):
            ...
            for face_landmarks in results.multi_face_landmarks:
                ...
                sqrtObjectWhite = Normalized()
                sqrt_size_white = sqrtObjectWhite.sqrtSizeNormalized(the_std_of_AVG_of_AVG_normalized_R_white, the_std_of_AVG_of_AVG_normalized_G_white, the_std_of_AVG_of_AVG_normalized_B_white)
                variance_white = sqrt_size_white**2
                distanceObjectWhite = Normalized()
                distance_size_white = distanceObjectWhite.distanceFromMean(normal_R, the_mean_of_AVG_of_AVG_normalized_R_white, normal_G, the_mean_of_AVG_of_AVG_normalized_G_white, normal_B, the_mean_of_AVG_of_AVG_normalized_B_white)

                
                ######calculating for black##########
                sqrtObjectBlack = Normalized()
                distanceObjectBlack = Normalized()
                sqrt_size_black = sqrtObjectBlack.sqrtSizeNormalized(the_std_of_AVG_of_AVG_normalized_R_black, the_std_of_AVG_of_AVG_normalized_G_black, the_std_of_AVG_of_AVG_normalized_B_black)
                variance_black = sqrt_size_black**2
                distance_size_black = distanceObjectBlack.distanceFromMean(normal_R, the_mean_of_AVG_of_AVG_normalized_R_black, normal_G, the_mean_of_AVG_of_AVG_normalized_G_black, normal_B, the_mean_of_AVG_of_AVG_normalized_B_black)

                
                ############################################################
                ratioBetweenBlackCenterAndBlackDistance = distance_size_black/(sqrt_size_black*(size_of_sqrt))*100
                ratioBetweenWhiteCenterAndWhiteDistance = distance_size_white/(sqrt_size_white*(size_of_sqrt))*100
                ...
                return isItWhite ,isItBlack ,ratioBetweenBlackCenterAndBlackDistance ,ratioBetweenWhiteCenterAndWhiteDistance, color_of_right_eye, color_of_left_eye
